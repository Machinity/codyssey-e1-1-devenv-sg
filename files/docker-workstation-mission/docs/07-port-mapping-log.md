...
임시로 실행해 포트 매핑을 검증합니다. (자세한 실행 방법은 [`app/README.md`](../app/README.md) 참고)
...
브라우저 접속 스크린샷: [screenshots/port-mapping/](../screenshots/port-mapping/) 🔲 port8080.png
...
브라우저 접속 스크린샷: [screenshots/port-mapping/](../screenshots/port-mapping/) 🔲 port8081.png
