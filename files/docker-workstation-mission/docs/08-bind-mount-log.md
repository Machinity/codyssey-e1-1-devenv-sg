...
`python3 -m http.server`로 디렉터리 목록을 노출해 반영 여부를 확인합니다.
...
```
스크린샷: [screenshots/bind-mount/](../screenshots/bind-mount/) 🔲 port8082_before.png
...
hello ros2
```
스크린샷: [screenshots/bind-mount/](../screenshots/bind-mount/) 🔲 port8082_after.png
